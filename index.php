                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form action="index.php" method="POST" class="d-flex" role="search"
                        ...
                        <input class="form-control me-2" name="search"
                            value="<?php echo (isset($search)) ? $search : ''; ?>" type="search" placeholder="Tìm kiếm"
                            aria-label="Search">
                        <button class="btn btn-outline-success" name="submit" value="submit-search"
        ...
        <section>
            <nav id="navbar2">
                <div class="dropdown">
                    ...
                    <button class="btn btn-secondary dropdown-toggle" id="dropdown" type="button"
                ...
                <div class="AddFile">
                    ...
                    <div class="popup" id="popup">
                        <form
                            style=" background: linear-gradient(135deg, #71b7e6, #9b59b6); border-radius:10px; padding:20px">
                            <h
                                style=" color: black; font-size: 25px; font-family: 'Times New Roman', Times, serif; margin-left: 35%;">
                                Chọn tập tin </h>
                ...
                <div>
                    <div class="popup" id="popupFolder">
                        <form
                            style=" background: linear-gradient(135deg, #71b7e6, #9b59b6); border-radius:10px; padding:20px">
                            <h
                                style=" color: black; font-size: 25px; font-family: 'Times New Roman', Times, serif; margin: 25%">
                                Nhập tên thư mục </h>
                            <!-- <input class="form-control" type="text" id="nameFile" placeholder="Tên tệp tin"> -->
